...
class HomePagina extends Pagina {
    ...
    onChange(messages) {
        ...
        messages.getBy(CommonCause.SET_PARAM).forEach(message => this.controller.setEffectParam(message.details.effect, message.details.param, message.details.value));
...
//# sourceMappingURL=HomePagina.js.map